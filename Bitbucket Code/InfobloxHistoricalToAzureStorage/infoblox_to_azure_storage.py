...
class InfobloxToAzureStorage(Utils):
    ...
    def __init__(self, start_time) -> None:
        ...
        super().__init__(consts.HISTORICAL_I_TO_S_FUNCTION_NAME)
            ...
            if status_of_last_from_date:
                ...
                applogger.info(
                    self.log_format.format(
                        ...
                        __method_name,
                        self.azure_function_name,
                        "Status of last from_date = {}".format(status_of_last_from_date),
                    )
                )
                ...
                applogger.info(
                    self.log_format.format(
                        ...
                        __method_name,
                        self.azure_function_name,
                        "This from_date occur for the first time.",
                    )
                )
                ...
                if response_data is None:
                    ...
                    applogger.info(
                        self.log_format.format(
                            ...
                            __method_name,
                            self.azure_function_name,
                            "Index = {}, Sent data, Fetching next chunk".format(index),
                        )
                    )
                    index += 1
                    response_data = chunk
    ...
    def get_infoblox_stream_response_obj(self, url, query_parameters=None):
        """Return response object to iterate.
